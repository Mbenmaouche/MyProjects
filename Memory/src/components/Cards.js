...
let CARDS = [
    { name: "cochon", id: "1", twinFind: false, src1: "./cochon.jpg", src: "./logo192.png" },
    { name: "cochon", id: "2", twinFind: false, src1: "./cochon.jpg", src: "./logo192.png" },
    { name: "zebre", id: "3", twinFind: false, src1: "./zebre.jpg", src: "./logo192.png" },
    { name: "zebre", id: "4", twinFind: false, src1: "./zebre.jpg", src: "./logo192.png" },
    { name: "renard", id: "5", twinFind: false, src1: "./renard.jpg", src: "./logo192.png" },
    { name: "renard", id: "6", twinFind: false, src1: "./renard.jpg", src: "./logo192.png" },
    { name: "perroquet", id: "7", twinFind: false, src1: "./perroquet.jpg", src: "./logo192.png" },
    { name: "perroquet", id: "8", twinFind: false, src1: "./perroquet.jpg", src: "./logo192.png" },
    { name: "tigre", id: "9", twinFind: false, src1: "./tigre.jpg", src: "./logo192.png" },
    { name: "tigre", id: "10", twinFind: false, src1: "./tigre.jpg", src: "./logo192.png" },
    { name: "cheval", id: "11", twinFind: false, src1: "./cheval.jpg", src: "./logo192.png" },
    { name: "cheval", id: "12", twinFind: false, src1: "./cheval.jpg", src: "./logo192.png" }
    ...
    const verifyCards = (tab) => {
        ...
        if (tab[0].src === tab[1].src) {
            ...
            if (verifyNbrTwins() === animals.length / 2) {
                setTimeout(function () {
                    alert("partie terminée, bien joué !");
                }, 500)
